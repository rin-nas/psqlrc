...
По умолчанию `psql` показывает в приглашении командной строки только название текущей базы и всё.
Используя всего один файл `~postgres/.psqlrc` можно значительно улучшить приглашение, 
