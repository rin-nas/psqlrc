-- https://github.com/rin-nas/postgresql-patterns-library/blob/master/functions/read_pgpass.sql
create function pro.read_pgpass(filename text)
    returns table (
        hostname text,
        port     text,
        database text,
...
comment on function pro.read_pgpass(filename text) is 'Read pgpass file';
