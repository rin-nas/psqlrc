...
psql -v pro=0 -q -f ~/psqlrc/commands/W.psql -U psqlrc_user psqlrc_db | sed 's/[↵¤]/ /g'
psql -v pro=0 -q -f ~/psqlrc/commands/A.psql -U psqlrc_user psqlrc_db | sed 's/[↵¤]/ /g'
psql -v pro=0 -q -f ~/psqlrc/commands/T.psql -U psqlrc_user psqlrc_db | sed 's/[↵¤]/ /g'
